...
exports.setOnLead = async (req, res) => {
  try {
    ...
    await lead.populate([
      ...
      { path: 'cardProduct', select: 'name cardType commissionBrackets cashbackCategories cardImage benefits', populate: { path: 'cashbackCategories.category', select: 'name' } },
      { path: 'loanProduct', select: 'name loanCategory commissionBrackets benefits' },
      { path: 'accountProduct', select: 'name accountCategory commissionBrackets benefits' },
