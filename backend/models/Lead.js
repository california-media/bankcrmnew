...
const leadSchema = new mongoose.Schema(
  {
    ...
    source: { type: String, enum: ['manual', 'referral', 'web_apply'], default: 'manual' },
    ...
    spendDone: { type: Boolean, default: false },
    spendNote: { type: String, trim: true },
    // PDC loan milestone
    pdcChqDone: { type: Boolean, default: false },
    pdcChqNote: { type: String, trim: true },
    // New STL Fresh loan milestones (either satisfies the flow)
    freshAccountOpenDone: { type: Boolean, default: false },
    freshAccountOpenNote: { type: String, trim: true },
    freshStlDone: { type: Boolean, default: false },
    freshStlNote: { type: String, trim: true },
    // Buyout loan milestones (sequential after the first alternative pair)
    buyoutAccountOpenDone: { type: Boolean, default: false },
    buyoutAccountOpenNote: { type: String, trim: true },
    buyoutLlReceivedDone: { type: Boolean, default: false },
    buyoutLlReceivedNote: { type: String, trim: true },
    buyoutMcSubmittedDone: { type: Boolean, default: false },
    buyoutMcSubmittedNote: { type: String, trim: true },
    buyoutClReceivedDone: { type: Boolean, default: false },
    buyoutClReceivedNote: { type: String, trim: true },
    buyoutStlDone: { type: Boolean, default: false },
    buyoutStlNote: { type: String, trim: true },
    // SME New Loan milestone
    smeAccountOpenDone: { type: Boolean, default: false },
    smeAccountOpenNote: { type: String, trim: true },
    // SME Buyout Loan milestones (sequential)
    smeBuyoutAccountOpenDone: { type: Boolean, default: false },
    smeBuyoutAccountOpenNote: { type: String, trim: true },
    smeBuyoutLlDone: { type: Boolean, default: false },
    smeBuyoutLlNote: { type: String, trim: true },
    smeBuyoutMcDone: { type: Boolean, default: false },
    smeBuyoutMcNote: { type: String, trim: true },
    smeBuyoutClDone: { type: Boolean, default: false },
    smeBuyoutClNote: { type: String, trim: true },
    // POS Loan / Non Bank milestones (both required, either order)
    posPdcDone: { type: Boolean, default: false },
    posPdcNote: { type: String, trim: true },
    posDdaDone: { type: Boolean, default: false },
    posDdaNote: { type: String, trim: true },
