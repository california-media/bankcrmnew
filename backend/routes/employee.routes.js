...
router.post('/', allowEmployeeTypes('coordinator'), upload.avatars.single('avatar'), ctrl.create);
...
router.patch('/:id', allowEmployeeTypes('coordinator'), upload.avatars.single('avatar'), ctrl.update);
