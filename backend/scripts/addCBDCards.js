...
const NEW_CARDS = [
  { name: 'CBD Super Saver Visa Credit Card',    minSalary: 5000,  cardType: 'rewards_lifestyle' },
  { name: 'CBD Smiles Visa Signature Credit Card', minSalary: 5000, cardType: 'rewards_lifestyle' },
  { name: 'CBD Visa Infinite Credit Card',       minSalary: 15000, cardType: 'legacy' },
  { name: 'CBD One Credit Card',                 minSalary: 5000,  cardType: 'regular' },
];
...
async function run() {
  ...
  const bank = await Bank.findOneAndUpdate(
    { code: 'CBD' },
    { $setOnInsert: { name: 'Commercial Bank of Dubai', code: 'CBD' } },
