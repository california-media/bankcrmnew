...
const NEW_CARDS = [
  { name: 'Invest Bank World Credit Card',    minSalary: 25000, cardType: 'legacy' },
  { name: 'Invest Bank Platinum Credit Card', minSalary: 5000,  cardType: 'regular' },
];
...
async function run() {
  ...
  const bank = await Bank.findOneAndUpdate(
    { code: 'Invest' },
    { $setOnInsert: { name: 'Invest Bank', code: 'Invest' } },
