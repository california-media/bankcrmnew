...
const NEW_CARDS = [
  { name: 'Mashreq Cashback Credit Card',   minSalary: 5000,  cardType: 'rewards_lifestyle' },
  { name: 'Mashreq noon Credit Card',        minSalary: 5000,  cardType: 'rewards_lifestyle' },
  { name: 'Mashreq Platinum Plus',           minSalary: 7000,  cardType: 'rewards_lifestyle' },
  { name: 'Mashreq Flash Cash',              minSalary: 7000,  cardType: 'regular' },
  { name: 'Mashreq Solitaire Credit Card',   minSalary: 25000, cardType: 'legacy' },
];
...
async function run() {
  ...
  const bank = await Bank.findOneAndUpdate(
    { code: 'Mashreq' },
    { $setOnInsert: { name: 'Mashreq Bank', code: 'Mashreq' } },
