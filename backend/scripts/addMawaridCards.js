...
const NEW_CARDS = [
  { name: 'Mawarid World Elite Card', minSalary: 30000, cardType: 'legacy' },
  { name: 'Mawarid World Card',       minSalary: 15000, cardType: 'legacy' },
  { name: 'Mawarid Platinum Card',    minSalary: 10000, cardType: 'rewards_lifestyle' },
  { name: 'Mawarid Titanium Card',    minSalary: 5000,  cardType: 'regular' },
];
...
async function run() {
  ...
  const bank = await Bank.findOneAndUpdate(
    { code: 'Mawarid' },
    { $setOnInsert: { name: 'Mawarid Finance', code: 'Mawarid' } },
