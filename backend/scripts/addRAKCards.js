...
const NEW_CARDS = [
  { name: 'Air Arabia Credit Card',                    minSalary: 5000,  cardType: 'travel' },
  { name: 'RAKBANK Red Mastercard Credit Card',        minSalary: 5000,  cardType: 'regular' },
  { name: 'RAKBANK Titanium Mastercard Credit Card',   minSalary: 8000,  cardType: 'regular' },
  { name: 'RAKBANK World Credit Card',                 minSalary: 20000, cardType: 'rewards_lifestyle' },
  { name: 'RAKBANK Elevate World Elite Mastercard',    minSalary: 35000, cardType: 'legacy' },
];
...
async function run() {
  ...
  const bank = await Bank.findOneAndUpdate(
    { code: 'RAK' },
    { $setOnInsert: { name: 'National Bank of Ras Al Khaimah', code: 'RAK' } },
