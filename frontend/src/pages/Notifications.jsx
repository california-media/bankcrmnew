...
export default function Notifications() {
  ...
  return (
    <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #e2e8f0', borderTop: '3px solid #7C3AED', overflow: 'hidden' }}>
      ...
      {notifications.map((n, idx) => (
        ...
        >
          ...
          <div style={{
            width: 42, height: 42, borderRadius: '50%', flexShrink: 0,
            background: `${TYPE_COLORS[n.type] || '#7C3AED'}18`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            color: TYPE_COLORS[n.type] || '#7C3AED', fontSize: 17,
            border: `1.5px solid ${TYPE_COLORS[n.type] || '#7C3AED'}30`,
          }}>
