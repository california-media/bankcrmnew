...
export default function ResetPassword() {
  ...
  if (!token) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #f3e8ff 0%, #f0f4ff 40%, #e8f0fe 100%)' }}>
  ...
  return (
    <div style={{
      ...
      background: 'linear-gradient(135deg, #f3e8ff 0%, #f0f4ff 40%, #e8f0fe 100%)',
      padding: 24,
    }}>
      <div style={{
        ...
        <Link to="/login" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 13, color: '#7C3AED', fontWeight: 500, marginBottom: 28 }}>
          <ArrowLeftOutlined /> Back to login
        </Link>

        <div style={{ marginBottom: 28 }}>
          <div style={{ width: 48, height: 48, borderRadius: 14, background: '#f3e8ff', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
            <LockOutlined style={{ fontSize: 22, color: '#7C3AED' }} />
          </div>
