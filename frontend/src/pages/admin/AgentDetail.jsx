...
export default function AgentDetail() {
  ...
  const columns = [
    ...
    { title: 'Commission', align: 'right', render: (_, r) => <span style={{ fontWeight: 600, color: '#7C3AED' }}>{aed(r.commission)}</span> },
  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto' }}>
      ...
      <Card
        ...
        extra={<Link to={`/admin/leads?agent=${id}`} style={{ fontSize: 13, color: '#7C3AED' }}>View all →</Link>}
      >
        <Table
          size="small"
          rowKey="_id"
