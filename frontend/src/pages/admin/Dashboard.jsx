...
/* ── Stat card ───────────────────────────────────────────────────── */
const StatCard = ({ title, value, icon, iconColor = '#7C3AED', trend, loading, link }) => {
  const inner = loading ? (
...
/* ── Mini stat strip ─────────────────────────────────────────────── */
const MiniStat = ({ label, value, color = '#7C3AED', link, icon }) => {
  const inner = (
    <div
      style={{
              ...
              <div style={{ flex: 1, position: 'relative' }}>
                <div style={{ height: 32, background: '#eef0f6', borderRadius: 999, overflow: 'hidden' }}>
                  <div style={{
                    ...
                    background: 'linear-gradient(90deg, #7C3AED 0%, #8b5cf6 40%, #0EA5E9 100%)',
...
const PRODUCT_COLORS = { credit_card: '#7C3AED', loan: '#0ea5e9' };
...
const AVATAR_BG    = ['#ede9fe', '#ddd6fe', '#e0f2fe', '#dcfce7', '#fce7f3', '#fef3c7'];
