  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 24px 16px' }}>
        ...
        <Link to="/admin/leads" style={{ display: 'flex', alignItems: 'center', gap: 4, fontWeight: 600, fontSize: 14, color: '#0f172a' }}>
      ...
      <div style={{ borderTop: '1px solid #f1f5f9' }}>
        {(!leads || leads.length === 0) && (
          <div style={{ padding: '32px 24px', textAlign: 'center', color: '#94a3b8', fontSize: 13 }}>No recent leads</div>
        )}
        {(leads || []).map((lead, i) => {
            ...
            <Link key={lead._id} to={`/admin/leads/${lead._id}`} style={{ display: 'block', textDecoration: 'none' }}>
              ...
              >
                ...
                <div style={{
                  ...
                  fontSize: 11, fontWeight: 700, letterSpacing: 0.5, color: st.text,
                }}>
                ...
                {/* Time */}
                <div style={{ fontSize: 12, color: '#94a3b8', whiteSpace: 'nowrap', marginLeft: 12, flexShrink: 0 }}>
