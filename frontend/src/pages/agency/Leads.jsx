...
const avatarBg = (name) => {
  const palette = ['#7C3AED','#ec4899','#14b8a6','#f59e0b','#8b5cf6','#06b6d4','#10b981','#f43f5e'];
    ...
    },
    {
      ...
      render: (_, row) => (
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontWeight: 700, fontSize: 13, color: row.commissionStatus === 'paid' ? '#16a34a' : '#7C3AED' }}>{aed(row.grossCommission)}</div>
              ...
              <Col key={row._id} xs={24} sm={12} lg={8}>
                <div
                  ...
                  style={{
                    ...
                    border: '1px solid #ede9fe', background: '#fafbff',
                    padding: '14px 16px',
                ...
                >
                    ...
                    <div style={{ marginBottom: 8 }}>
                      ...
                      {row.bank?.name && (
                        <span style={{ display: 'inline-block', fontSize: 11, fontWeight: 500, color: '#7C3AED', background: '#f3e8ff', border: '1px solid #e9d5ff', borderRadius: 999, padding: '1px 8px', marginTop: 4 }}>
                          {row.bank.name}
                        </span>
                      )}
                    </div>
