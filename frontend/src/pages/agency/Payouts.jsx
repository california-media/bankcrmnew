    ...
    },
    {
      ...
      render: (_, row) => {
        if (row.receiptFile) {
          return (
            <a
              href={`${UPLOADS_BASE}/receipts/${row.receiptFile}`}
              target="_blank"
              rel="noreferrer"
    ...
    <>
      ...
      <Row gutter={16} style={{ marginBottom: 20 }}>
        {[
          ...
          { color: '#7C3AED', icon: <WalletOutlined />, label: 'BUCKET BALANCE', value: aed(bucketBalance), sub: 'Available as credit' },
              ...
              <Table
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    dataIndex: 'amount',
                    align: 'right',
                    render: (v) => <Typography.Text strong style={{ color: '#7C3AED' }}>{aed(v)}</Typography.Text>,
                  },
                  {
                    title: 'Note',
                    dataIndex: 'note',
      ...
      >
        <Descriptions size="small" column={1} style={{ marginBottom: 16 }} bordered>
          ...
          <Descriptions.Item label="Bucket balance">
            <Typography.Text style={{ color: '#7C3AED', fontWeight: 600 }}>{aed(bucketBalance)}</Typography.Text>
          </Descriptions.Item>
        </Descriptions>
        ...
        <Form form={payoutForm} layout="vertical">
          ...
          {paymentMethod === 'bucket' && (
            <>
              <div style={{ background: '#f3e8ff', borderRadius: 8, padding: '12px 14px', marginBottom: 14, fontSize: 13 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                  <span style={{ color: '#7C3AED' }}>Bucket balance</span>
      ...
      <Modal
        title={<span><WalletOutlined style={{ marginRight: 8, color: '#7C3AED' }} />Add to Wallet</span>}
        open={walletOpen}
      ...
      >
        ...
        <div style={{ background: '#f3e8ff', borderRadius: 8, padding: '10px 14px', marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: 12, color: '#7C3AED', fontWeight: 600 }}><WalletOutlined style={{ marginRight: 5 }} />Current Balance</span>
