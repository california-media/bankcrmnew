...
function LeadCard({ lead, onClick }) {
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.boxShadow = '0 6px 20px rgba(124,58,237,0.18), 0 2px 6px rgba(124,58,237,0.10)';
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #f1f5f9', paddingTop: 8 }}>
        ...
        {commission && (
          <span style={{ fontSize: 12, fontWeight: 700, color: '#7C3AED' }}>{commission}</span>
        )}
      </div>
    </div>
  );
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          {(bankFilter || agentFilter || agencyFilter) && (
            <button
              ...
              style={{ fontSize: 12, color: '#7C3AED', background: 'none', border: 'none', cursor: 'pointer', padding: '0 4px', fontWeight: 500 }}
            >
              Clear
            </button>
          )}
          ...
          options={[
            {
              ...
              label: (
                <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                  <CreditCardOutlined />
                  Credit Card
                  <span style={{ fontSize: 10, fontWeight: 700, background: '#ede9fe', color: '#7C3AED', borderRadius: 999, padding: '0 6px', marginLeft: 2 }}>
                    {creditCardCount}
                  </span>
                </span>
              ),
