        ...
        return hasReceipt ? (
          <Space direction="vertical" size={0}>
            ...
            {row.disbursementReceiptFile && (
              <a
                href={`${UPLOADS_BASE}/receipts/${row.disbursementReceiptFile}`}
                target="_blank"
                rel="noreferrer"
                style={{ fontSize: 11 }}
  ...
  return (
    <>
      ...
      <Row gutter={16} style={{ marginBottom: 20 }}>
        <Col xs={24} sm={8}>
          <Card size="small" style={{ borderRadius: 10, borderLeft: '4px solid #7C3AED', background: '#f3e8ff', border: '1px solid #e9d5ff' }} styles={{ body: { padding: '14px 16px' } }}>
            <Statistic title={<span style={{ fontSize: 12, color: '#7C3AED', fontWeight: 600 }}>Total Disbursed</span>} value={stats.total} valueStyle={{ fontWeight: 800, color: '#7C3AED', fontSize: 22 }} />
          </Card>
        </Col>
        <Col xs={24} sm={8}>
