    ...
    },
    {
      ...
      render: (_, row) => (
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontWeight: 700, fontSize: 13, color: row.commissionStatus === 'paid' ? '#16a34a' : '#7C3AED' }}>{aed(row.commission)}</div>
            ...
            return (
              <Col key={row._id} xs={24} sm={12} lg={8} xl={6}>
                <div
                  ...
                  className="lead-card"
                  style={{
                    borderRadius: 14, border: '1px solid #ede9fe', cursor: 'pointer', height: '100%',
                ...
                >
                  ...
                  {row.bank?.name && (
                    <span style={{ display: 'inline-block', fontSize: 11, fontWeight: 500, color: '#7C3AED', background: '#f3e8ff', border: '1px solid #e9d5ff', borderRadius: 999, padding: '2px 10px', marginBottom: 10 }}>
                      {row.bank.name}
                    </span>
                  )}
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #f1f5f9', paddingTop: 10 }}>
                    ...
                    <span style={{ fontWeight: 700, fontSize: 13, color: row.commissionStatus === 'paid' ? '#16a34a' : '#7C3AED' }}>{aed(row.commission)}</span>
                  </div>
                </div>
              </Col>
            );
